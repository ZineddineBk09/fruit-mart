...
const Products = dynamic(
  () => import("@/components/shared/products/Products"),
  {
    ssr: false,
...
const sortOptions = [
  ...
  { name: "السعر: من الأدنى إلى الأعلى", href: "#", current: false },
  { name: "السعر: من الأعلى إلى الأدنى", href: "#", current: false },
];
const subCategories = [
  { name: "موز", href: "#" },
  { name: "كيوي", href: "#" },
...
const filters = [
  {
    ...
    name: "الفئة",
    options: [
      { value: "fruits", label: "فاكهة", checked: false },
      { value: "vegetables", label: "خضروات", checked: false },
    ],
  },
  {
    id: "size",
    ...
    options: [
      ...
      { value: "plate", label: "صحن", checked: false },
    ],
  },
];
  ...
  return (
    <div className="bg-white">
      <div>
              ...
              >
                <Dialog.Panel className="relative mr-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                  <div className="flex items-center justify-between px-4">
                    <h2 className="text-lg font-medium text-gray-900">فرز</h2>
                    <button
                      type="button"
        ...
        <main className="mx-auto max-w-[1350px] px-2 lg:px-4">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            ...
            <div className="flex items-center">
              ...
              >
                <span className="sr-only">التصفية</span>
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                <Products
                  title="الفواكه والخضروات الطازجة"
                  products={products}
                />
                <Products title="الأكثر مبيعًا" products={products} />
                <Products title="منتجاتنا" products={products} />
              </div>
            </div>
          </section>
        </main>
